...
zhengshoutiaoDetailScreenView::zhengshoutiaoDetailScreenView()
{

}

void zhengshoutiaoDetailScreenView::setupScreen() {
    zhengshoutiaoDetailScreenViewBase::setupScreen();
...
void zhengshoutiaoDetailScreenView::tearDownScreen()
{
    zhengshoutiaoDetailScreenViewBase::tearDownScreen();
}