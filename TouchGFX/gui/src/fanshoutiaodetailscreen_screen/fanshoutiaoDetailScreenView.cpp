...
fanshoutiaoDetailScreenView::fanshoutiaoDetailScreenView()
{

}

void fanshoutiaoDetailScreenView::setupScreen() {
    fanshoutiaoDetailScreenViewBase::setupScreen();
...
void fanshoutiaoDetailScreenView::tearDownScreen()
{
    fanshoutiaoDetailScreenViewBase::tearDownScreen();
}