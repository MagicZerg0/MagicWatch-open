...
shaqiuDetailScreenView::shaqiuDetailScreenView()
{

}

void shaqiuDetailScreenView::setupScreen() {
    shaqiuDetailScreenViewBase::setupScreen();
...
void shaqiuDetailScreenView::tearDownScreen()
{
    shaqiuDetailScreenViewBase::tearDownScreen();
}