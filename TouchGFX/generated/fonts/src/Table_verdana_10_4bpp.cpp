...
KEEP extern const touchgfx::GlyphNode glyphs_verdana_10_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE = {
    ...
    {    54, 0x0064,   6,   8,   8,   0,   6,   0,   0, 0x00 },
    {    78, 0x0065,   6,   6,   6,   0,   6,   0,   0, 0x00 },
    {    96, 0x0067,   6,   8,   6,   0,   6,   0,   0, 0x00 },
...
touchgfx::GeneratedFont& getFont_verdana_10_4bpp()
{
    static touchgfx::GeneratedFont verdana_10_4bpp(glyphs_verdana_10_4bpp, 7, 12, 10, 0, 0, 4, 1, 0, 0, unicodes_verdana_10_4bpp, kerning_verdana_10_4bpp, 63, 0, 0, 0);
