...
extern "C" {
bool touchgfxDisplayDriverTransmitActive()
{
    return ST7789_DMA_IsBusy();
}
bool touchgfxDisplayDriverShouldTransferBlock(uint16_t bottom)
{
    (void)bottom;
    return true;
}
...
{
    ST7789_DrawBitmap_NoWait(x, y, w, h, pixels);
}
void touchgfxTaskEntry(void)
{
